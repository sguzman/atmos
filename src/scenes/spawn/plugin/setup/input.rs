...
use crate::scenes::{
    ...
    input::{SceneInputConfig, resolve_camera_input_config, resolve_overlay_toggles},
    loaders::{ConfigLoad, TomlCache, load_input_config},
};
...
pub(crate) fn load_scene_input(
    ...
    let input_config: InputConfig =
        match load_input_config(&active_scene.name, toml_cache, asset_server, toml_assets) {
            ConfigLoad::Pending => {
                return None;
            }
