...
use crate::scenes::{
    ...
    config::ActiveScene,
    input::{
        apply_camera_input, apply_debug_menu_toggle, apply_dialogue_action, apply_fov_action,
        apply_grab_action, apply_grenade_action, apply_jump_action, apply_noclip_toggle,
        apply_pause_toggle, apply_player_respawn, apply_shoot_action, apply_sprint_toggle,
        apply_zoom_action, update_action_states, update_debug_menu_ui, update_grab_hold,
...
impl Plugin for ScenePlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Update, apply_debug_menu_toggle.run_if(in_state(AppState::Main)));
        app.add_systems(
            Update,
        ...
        app.add_systems(Update, apply_dialogue_action.run_if(in_state(AppState::Main)));
