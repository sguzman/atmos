use crate::scenes::config::{
    ...
    PhysicsConfig, PhysicsOverrides,
    ShapeConfig, ShapeOverrides,
    TransformOverrides,
};
...
pub(in crate::scenes::spawn) fn merge_shape(
    ...
    if let Some(ovr) = overrides {
        ...
        if let Some(cuttable) =
            ovr.cuttable
        {
            merged.cuttable = cuttable;
        }
    }
    merged
}
...
pub(in crate::scenes::spawn) fn merge_physics(
    ...
    if let Some(ovr) = overrides {
        ...
        if let Some(restitution) =
            ovr.restitution
        {
            merged.restitution =
                restitution;
        }
        if let Some(friction) =
            ovr.friction
        {
