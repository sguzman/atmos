...
use crate::scenes::config::{
    ActiveScene, LightComponent,
    LightEntry, LightKind, parse_color,
};
...
pub(in crate::scenes::spawn) fn spawn_light_component(
    ...
    let world_pos = base_transform
        .transform_point(offset);
